...
public class StreamsReportTest {
    ...
    public void testGetNumberOfSuppliers() {
        int numberOfSuppliers = WarehouseReportStreams.getNumberOfSuppliers(warehouse);
        assertEquals("Number of suppliers should be 2", 2, numberOfSuppliers);
    }

    @Test
    public void testGetNumberOfProducts() {
        int numberOfProducts = WarehouseReportStreams.getNumberOfProducts(warehouse);
        assertEquals("Total number of products should be 2", 2, numberOfProducts);
    }

    @Test
    public void testGetSuppliersSorted() {
        SortedSet<Supplier> sortedSuppliers = WarehouseReportStreams.getSuppliersSorted(warehouse);
    ...
    public void testGetProductsSortedByQuantity() {
        SortedSet<Product> sortedProducts = WarehouseReportStreams.getProductsSortedByQuantity(warehouse);
